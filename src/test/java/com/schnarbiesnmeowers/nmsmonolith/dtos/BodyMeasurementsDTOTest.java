...
/**
 * class to test the BodyMeasurementsDTO class
...
public class BodyMeasurementsDTOTest {
	...
	public void testClass() {
		BodyMeasurementsDTO classUnderTest = new BodyMeasurementsDTO();
		...
		assertTrue(true);
		BodyMeasurementsDTO newitem = new BodyMeasurementsDTO(
