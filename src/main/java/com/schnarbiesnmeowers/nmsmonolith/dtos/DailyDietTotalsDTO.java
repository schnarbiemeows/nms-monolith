 ...
 *
 */
public class DailyDietTotalsDTO implements Serializable {
	 ...
	 * default constructor
	 */
	public DailyDietTotalsDTO() {
		super();
	}

	public DailyDietTotalsDTO(Integer dailyDietTotalId, Integer userId, Date calendarDate, Integer bldstId,
	...
	public String toString() {
		return "DailyDietTotalsDTO [dailyDietTotalId=" + dailyDietTotalId + ", userId=" + userId + ", calendarDate=" + calendarDate + ", bldstId=" + bldstId + ", kcalories=" + kcalories + ", totFat=" + totFat + ", satFat=" + satFat + ", transFat=" + transFat + ", polyFat=" + polyFat + ", monoFat=" + monoFat + ", choles=" + choles + ", sodium=" + sodium + ", totCarbs=" + totCarbs + ", totFiber=" + totFiber + ", totSugars=" + totSugars + ", totProtein=" + totProtein + "]";
	}

	public static DailyDietTotalsDTO fromJson(String input) {
		Gson gson = new Gson();
		return gson.fromJson(input, DailyDietTotalsDTO.class );
	}
	public DailyDietTotals toEntity() {
		return new DailyDietTotals(this.getDailyDietTotalId(),this.getUserId(),this.getCalendarDate(),
		this.getBldstId(),this.getKcalories(),this.getTotFat(),this.getSatFat(),this.getTransFat(),
		this.getPolyFat(),this.getMonoFat(),this.getCholes(),this.getSodium(),
