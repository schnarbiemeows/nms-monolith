...
public class BldstUtility {
    ...
    public static final String BLDST_SNACK = "S";

    public static final String BLDST_MEAL1 = "M1";
    public static final String BLDST_MEAL2 = "M2";
    public static final String BLDST_MEAL3 = "M3";
