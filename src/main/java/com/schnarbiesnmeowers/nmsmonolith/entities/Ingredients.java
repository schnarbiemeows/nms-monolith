...
public class Ingredients implements Serializable {
	...
	public Ingredients(Integer ingrId, String ingrDesc, Integer ingrTypeId, Integer brandId, BigDecimal servSz, Integer servTypeId, BigDecimal kcalories, BigDecimal totFat, BigDecimal satFat, BigDecimal transFat, BigDecimal polyFat, BigDecimal monoFat, BigDecimal choles, Integer sodium, BigDecimal totCarbs, BigDecimal totFiber, BigDecimal totSugars, BigDecimal totProtein, BigDecimal glycIndx, Integer imageLoc, String actv) {
		super();
		this.ingrId = ingrId;
	...
	public String toString() {
		return "Ingredients [ingrId=" + ingrId + ", ingrDesc=" + ingrDesc + ", ingrTypeId=" + ingrTypeId + ", brandId=" + brandId + ", servSz=" + servSz + ", servTypeId=" + servTypeId + ", kcalories=" + kcalories + ", totFat=" + totFat + ", satFat=" + satFat + ", transFat=" + transFat + ", polyFat=" + polyFat + ", monoFat=" + monoFat + ", choles=" + choles + ", sodium=" + sodium + ", totCarbs=" + totCarbs + ", totFiber=" + totFiber + ", totSugars=" + totSugars + ", totProtein=" + totProtein + ", glycIndx=" + glycIndx + ", imageLoc=" + imageLoc + ", actv=" + actv + "]";
	}

	public static Ingredients fromJson(String input) {
		Gson gson = new Gson();
		return gson.fromJson(input, Ingredients.class );
	}
	public IngredientsDTO toDTO() {
		return new IngredientsDTO(this.getIngrId(),this.getIngrDesc(),this.getIngrTypeId(),this.getBrandId(),this.getServSz(),this.getServTypeId(),this.getKcalories(),this.getTotFat(),this.getSatFat(),this.getTransFat(),this.getPolyFat(),this.getMonoFat(),this.getCholes(),this.getSodium(),this.getTotCarbs(),this.getTotFiber(),this.getTotSugars(),this.getTotProtein(),this.getGlycIndx(),this.getImageLoc(),this.getActv());
	}
}
